...
//  de façon universelle. CRA, Next.js, Remix ont tous des
//  comportements différents pour les CSS dans node_modules/.
//  Injecter via JS est la seule approche qui fonctionne
//  partout sans configuration supplémentaire de l'installateur.
//
//  La balise est créée une seule fois (vérification de l'id)
//  même si le composant est monté plusieurs fois sur la page.
// ============================================================

export function injectKalendarStyles() {
  ...
  style.textContent = `/*
  Kalendar.css
  Feuille de style du composant npm @najororabiaza/kalendar.

  PHILOSOPHIE DE CE FICHIER :
  Chaque valeur visuelle est une CSS Variable.
  L'installateur peut surcharger n'importe quelle variable
  depuis son propre CSS, sans modifier ce fichier.

  COMMENT SURCHARGER :
  Dans votre propre CSS, ciblez le conteneur du composant :

    .mon-conteneur-calendrier {
      --kal-bg:               #1a1a2e;
      --kal-font-size-event:  12px;
      --kal-slot-height:      30px;
    }

  Ou en passant un objet style directement sur le composant :

    <Kalendar style={{ "--kal-bg": "#1a1a2e" }} ... />

  TABLE COMPLÈTE DES VARIABLES (avec leurs valeurs par défaut) :
  ─────────────────────────────────────────────────────────────

  COULEURS PRINCIPALES
  --kal-bg                  #ffffff       Fond général
  --kal-primary             #a8cbff       Bandeau des jours, bordure top
  --kal-accent              #eef4ff       Colonne des heures
  --kal-text-primary        #004085       Texte dans le bandeau des jours
  --kal-text-secondary      #333333       Texte secondaire (header right)
  --kal-text-hour           #0033cc       Labels des heures
  --kal-header-prefix-color #ffcc00       Couleur du préfixe dans l'en-tête
  --kal-header-title-color  #28a745       Couleur du titre dans l'en-tête

  GRILLE
  --kal-border-top          2px solid #a8cbff   Bordure supérieure du calendrier
  --kal-border-col          #d0d0d0              Séparation verticale entre jours
  --kal-border-hour         1px solid #999999   Ligne d'heure pleine
  --kal-border-quarter      1px dashed #cccccc  Ligne de quart d'heure
  --kal-border-hour-col     #c0c0c0             Bordure droite colonne heures
  --kal-slot-height         22px                Hauteur d'un créneau de 15 min
  --kal-day-border          1px solid #ffffff   Bordure entre colonnes de jours

  TYPOGRAPHIE
  --kal-font                Arial, Helvetica, sans-serif   Police générale
  --kal-font-size-base      11px       Taille de police de base du calendrier
  --kal-font-size-hour      11px       Taille des labels d'heures
  --kal-font-size-header    12px       Taille de l'en-tête
  --kal-font-size-event     10px       Titre dans un bloc événement
  --kal-font-size-event-time 9px      Heure dans un bloc événement

  ÉVÉNEMENTS (blocs colorés)
  --kal-event-border-color  #ffffff    Bordure entre blocs événements
  --kal-event-text-color    #ffffff    Couleur du texte dans les blocs
  --kal-event-border-radius 0px        Border-radius des blocs
  --kal-event-padding       2px        Padding interne des blocs

  THÈME SOMBRE (activé via data-theme="dark" sur le conteneur)
  Ces variables sont surchargées automatiquement en mode sombre.
  Tu peux les surcharger depuis ton CSS pour personnaliser le mode sombre.
  --kal-dark-bg             #1a1a2e
...
.kal-container {
  ...
  /* Thème sombre (valeurs utilisées quand data-theme="dark") */
  --kal-dark-bg:                  #1a1a2e;
  --kal-dark-primary:             #0f3460;
  --kal-dark-accent:              #16213e;
  --kal-dark-text-primary:        #a8cbff;
...
/* ============================================================
   THÈME SOMBRE — active les variables --kal-dark-* définies
   ci-dessus. L'installateur peut surcharger les --kal-dark-*
   pour personnaliser son propre mode sombre.
   ============================================================ */
...
/* ============================================================
   BORDURE SUPÉRIEURE DU CALENDRIER
   ============================================================ */
...
/* ============================================================
   FOND AUJOURD'HUI — désactive le jaune FullCalendar par défaut
   ============================================================ */
